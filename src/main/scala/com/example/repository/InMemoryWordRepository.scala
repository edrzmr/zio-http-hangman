...
import com.example.repository.InMemoryWordRepository.words
...
object InMemoryWordRepository {
  ...
  val live: ULayer[InMemoryWordRepository] = ZLayer {
    ZIO.attempt(new InMemoryWordRepository()).orDie
  }
